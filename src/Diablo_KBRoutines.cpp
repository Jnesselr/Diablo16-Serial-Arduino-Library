...
void refreshstate(Diablo_Serial_4DLib Display, word hndl, int8_t iKB, int8_t * oKB)
{
  int8_t shifted ;
...
void kbDown(Diablo_Serial_4DLib Display, word hndl, int8_t iKB, int8_t * oKB, uint8_t * KBKeys, int8_t key, Callback handler)
{
  int8_t keyval ;
  oKB[KbMvt] = 1 ;
  oKB[KbIgn] = 0 ;
...
void kbUp(Diablo_Serial_4DLib Display, word hndl, int8_t iKB, int8_t * oKB)
{
  if (!oKB[KbIgn])
  {
